...
function ParticipantList({ courses, refreshCourses }) {
  ...
  // --- AUTO-ASSIGN (Updated Male 10x8, J..A) ---
  ...
  if (viewMode === 'seating') { 
    ...
    // Male Grid: Visual J...A (Col 0 is J, Col 9 is A)
    const renderMaleGrid = (map, cols, rows) => { let grid = []; for (let r = 0; r < rows; r++) { let rowCells = []; const rowNum = r+1; for (let c = 0; c < cols; c++) { 
        // Visual: J on left (idx 0), A on right (idx 9)
        // Letter logic: J is 74, A is 65.
        // c=0 -> J (74), c=9 -> A (65). Formula: 74 - c
