...
export default function ParticipantList({ courses, refreshCourses }) {
  ...
  // ✅ STATS CALCULATOR (For Auto-Assign Modal)
  ...
  // ✅ PRINT RENDERER: Filter by Gender Context to prevent duplicates
  const renderCell = (id, p, gender) => {
      // 🛡️ GUARD: Only render student if their gender matches the side being printed
  ...
  if (viewMode === 'seating') { 
      ...
      return (
          <div style={styles.card}>
              ...
              {/* ✅ AUTO-ASSIGN MODAL WITH LIVE STATS */}
