...
export default function StudentForm({ courseId, student = null, onSave, onCancel }) {
  ...
  // Data Lists
  const [courseStudents, setCourseStudents] = useState([]); // List of students in this course
  ...
  // --- ORIGINAL LOGIC: FETCH DATA FOR THIS COURSE ---
  const loadCourseData = async () => {
      try {
          // 1. Get Course Details (Name)
          ...
          // 2. Get Students for THIS Course (Restores "List all students" logic)
          ...
          // 4. Smart Laundry (Filter used ones)
          ...
          // Allow current student's token if editing
  ...
  const handleChange = (e) => {
    ...
    // AUTO-POPULATE: When selecting a student from the list
    if (name === 'full_name') {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    onSave(formData); // Parent handles API save
        ...
        <div style={{display:'grid', gridTemplateColumns:'2fr 1fr 1fr 1fr', gap:'15px', marginBottom:'15px'}}>
            <div>
                ...
                <div style={{display:'flex', alignItems:'center', border:'1px solid #ddd', borderRadius:'4px', padding:'0 5px'}}>
                    ...
                    {/* ORIGINAL LOGIC: Datalist populated by courseStudents */}
