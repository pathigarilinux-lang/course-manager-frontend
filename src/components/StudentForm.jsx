...
export default function StudentForm({ courses, preSelectedRoom, clearRoom, userRole }) {
  ...
  // ✅ TAB STATE: Default strictly to 'New Block' if dn1ops
  ...
  const handleOpenRoomModal = () => {
      // ✅ LOGIC: If dn1ops, Force 'New Block', else auto-detect gender
      if (userRole === 'dn1ops') {
  ...
  // Handle manual reset of room field
                          ...
                          <div style={{display:'flex', borderBottom:'1px solid #ddd'}}>
                              {['Male', 'Female', 'New Block'].map(tab => (
                                  <button 
                                      ...
                                      style={{
                                          flex:1, padding:'15px', background: roomModalTab === tab ? 'white' : '#f1f3f5', 
                                          border:'none', borderBottom: roomModalTab === tab ? '3px solid #007bff' : 'none',
                                          fontWeight: 'bold', color: roomModalTab === tab ? '#007bff' : '#666', cursor:'pointer'
                                      }}
                                  >
                                      {tab} Block
                                  </button>
