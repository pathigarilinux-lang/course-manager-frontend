          ...
          <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'30px'}}>
              <div style={{border:'2px dashed #ccc', borderRadius:'12px', padding:'40px', textAlign:'center', background:'#f9f9f9', position:'relative', transition:'all 0.2s', ':hover':{borderColor:'#28a745', background:'#f0fff4'}}}>
                ...
                <div style={{pointerEvents:'none'}}>
                    <div style={{width:'60px', height:'60px', background:'#e9ecef', borderRadius:'50%', display:'flex', alignItems:'center', justifyContent:'center', margin:'0 auto 15px auto'}}><FileText size={30} color="#28a745"/></div>
                ...
                <div style={{marginTop:'30px', pointerEvents:'auto'}}>
                    <button onClick={downloadTemplate} style={{background:'white', border:'1px solid #ddd', padding:'8px 15px', borderRadius:'20px', color:'#28a745', cursor:'pointer', fontSize:'12px', display:'flex', alignItems:'center', justifyContent:'center', gap:'5px', margin:'0 auto'}}><Download size={12}/> Download Excel Template</button>
                </div>
              </div>
