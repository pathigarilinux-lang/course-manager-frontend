...
export default function CourseDashboard({ courses }) {
  ...
  const stats = useMemo(() => {
      ...
      const gateStats = getBreakdown(atGate);
      ...
      return { total: valid.length, expectedMale, expectedFemale, totalArrived: totalArrived.length, fullyCheckedIn: fullyCheckedIn.length, gateStats, arrivedStats, pendingStats, ageData, catData, discourseData, criticalPendingList, criticalStats, seatingStats }; 
  }, [participants]);
